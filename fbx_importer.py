        ...
        for link in links:
            ...
            link_signatures.append(
                (
                    ...
                    getattr(to_node, 'type', None),
                    getattr(to_socket, 'name', None),
                )
            )

    return (tuple(node_signatures), tuple(sorted(link_signatures)))
