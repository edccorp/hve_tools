...
- For HVE FBX files, open **Post-Simulation Processing → HVE FBX Importer**, choose the `.fbx`, optionally enable **Merge Body Mesh**, choose **Shape Keys** or **External MDD File** deformation storage, and import.
